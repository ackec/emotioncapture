...
class CustomDataset(Dataset):
    def __init__(self, data, image_dir, transform=None, device = torch.device("cuda" if torch.cuda.is_available() else "cpu")):
        self.data = data
    ...
    def __getitem__(self, idx):
        ...
        frame_path = os.path.join(self.image_dir, f"018757_frame{int(frame_info['Frame_ID'])}.jpg")  # Adjust to your file path structure

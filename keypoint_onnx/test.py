...
img = cv2.imread('olivia_images/002446-opto2022-05-24-09h34m18s825.png')



def main():
    # Create Detector and Pose Detector
    detector = Detector(model_path='keypoint_onnx/mmdeploy_models/mmdet/ort', device_name='cpu', device_id=0)
    pose_detector = PoseDetector(model_path='keypoint_onnx/mmdeploy_models/mmpose/ort', device_name='cpu', device_id=0)
